...
<!-- Mirrored from uitheme.net/sociala/default-member.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Nov 2023 14:44:23 GMT -->
<head>
<meta charset="UTF-8">
							...
							<div class="row ps-2 pe-2">
								<c:forEach var="i" items="${listfriend}">
									<div class="col-md-3 col-sm-4 pe-2 ps-2">
										<div
											class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3 mt-0">
											<div
												...
												<h4 class="fw-700 font-xsss mt-3 mb-1">${i.userName}</h4>
												<p class="fw-500 font-xsssss text-grey-500 mt-0 mb-3">${i.email}</p>
												<a href="deletefriend?userid=${i.userID}"
