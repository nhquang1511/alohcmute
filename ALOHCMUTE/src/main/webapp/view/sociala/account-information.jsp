...
<!-- Mirrored from uitheme.net/sociala/account-information.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Nov 2023 14:44:45 GMT -->
<head>
<meta charset="UTF-8">
			...
			<div
				...
				<div class="card bg-transparent-card w-100 border-0 ps-5 mb-3">
					<img src="images/user-7.png" alt="user"
						class="w40 position-absolute left-0">
					<h5 class="font-xsss text-grey-900 mb-1 mt-0 fw-700 d-block">${sessionScope.UserName}
					...
					<div class="middle-wrap">
						<div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
							<div
								...
								<h4 class="font-xs text-white fw-600 ms-4 mb-0 mt-2">Account
									Details</h4>
							</div>
							<div class="card-body p-lg-5 p-4 w-100 border-0 ">
								...
								<form action="/ALOHCMUTE/updateuser" method="post" enctype="multipart/form-data">
