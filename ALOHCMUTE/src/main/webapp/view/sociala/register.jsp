    ...
    <div class="main-wrap">
        ...
        <div class="nav-header bg-transparent shadow-none border-0">
            <div class="nav-top w-100">
                ...
                <a href="login.jsp" class="header-btn d-none d-lg-block bg-dark fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 rounded-xl">Login</a>
                <a href="register.jsp" class="header-btn d-none d-lg-block bg-current fw-500 text-white font-xsss p-3 ms-2 w100 text-center lh-20 rounded-xl">Register</a>
                    ...
                    <div class="card-body rounded-0 text-left">
                        ...
                        <form action="/ALOHCMUTE/register" method="post">
                            ...
                            <div class="form-group icon-input mb-3">
                                ...
                                <input name="name" type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Your Name">                        
                            </div>
                            <div class="form-group icon-input mb-3">
                            ...
                            <div class="form-group icon-input mb-1">
                                <input name="confirm_password" type="Password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Confirm Password">
                                <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                            </div>
...
<!-- Mirrored from uitheme.net/sociala/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Nov 2023 14:44:42 GMT -->
</html>