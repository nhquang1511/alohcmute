...
<main>
  ...
  <div class="container pt-4">
    ...
    <section class="mb-4" id="PostThang" style="margin-top:100px">
      <div class="card">
        <div class="card-header py-3">
          <h5 class="mb-0 text-center"><strong>Số lượng bài post theo từng tháng</strong></h5>
        </div>
        <div class="card-body">
...
"datasets": [{
"label": "",
"data": [${sessionScope.thang12}, ${sessionScope.thang11}, ${sessionScope.thang10}, ${sessionScope.thang9}, ${sessionScope.thang8}, ${sessionScope.thang7}, ${sessionScope.thang6}, ${sessionScope.thang5}, ${sessionScope.thang4}, ${sessionScope.thang3}, ${sessionScope.thang2}, ${sessionScope.thang1}],
"fill": false,
