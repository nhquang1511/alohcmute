    ...
    <section class="mb-4" id="doanhThuThu" style="margin-top:100px">
      <div class="card">
        <div class="card-header py-3">
          <h5 class="mb-0 text-center"><strong>Số lượng post trong 6 giờ gần nhất</strong></h5>
        </div>
        <div class="card-body">
...
<!-- SCRIPTS -->
 ...
 <!-- MDB -->
  ...
  //pie
    ...
    type: 'pie',
    data: {
    labels: ["Cách đây 0 giờ", "Cách đây 1 giờ", "Cách đây 2 giờ", "Cách đây 3 giờ", "Cách đây 4 giờ", "Cách đây 5 giờ", "Cách đây 6 giờ"],
    datasets: [{
    data: [${sessionScope.cachDay0Gio}, ${sessionScope.cachDay1Gio}, ${sessionScope.cachDay2Gio},${sessionScope.cachDay3Gio}, ${sessionScope.cachDay4Gio}, ${sessionScope.cachDay5Gio}, ${sessionScope.cachDay6Gio}],
